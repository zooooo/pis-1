...
<body>
	...
	<div class="map_wrap">
		<div id="map"
			style="width: 1280px; height: 900px; position: relative; overflow: hidden;"></div>
	...
	<script>
		...
		mapOption = {
			center : new daum.maps.LatLng(37.499099, 127.032123), // 지도의 중심좌표
			level : 3
		// 지도의 확대 레벨
		};
		...
		function setCenter() {
			// 이동할 위도 경도 위치를 생성합니다 
			var moveLatLon = new daum.maps.LatLng(37.499099, 127.032123);
	...
	<input type="button" value="중심으로 ㄱㄱ" onclick="setCenter()">&nbsp;&nbsp;&nbsp;&nbsp;
	<input type="button" value="부드럽게 중심으로" onclick="panTo()">
</body>
</html>